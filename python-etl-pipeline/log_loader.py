"""
A module that parses and retrieves configuration files (default: reads *.cfg files in the same directory as this module).
"""
...
class LogLoader:
    ...
    def load_batch_log(self, total_elapsed_time: datetime.datetime):
